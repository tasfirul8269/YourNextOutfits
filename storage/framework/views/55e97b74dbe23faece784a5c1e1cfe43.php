<?php if(Frooxi\Product\Helpers\ProductType::hasVariants($product->type)): ?>
    <?php echo view_render_event('frooxi.shop.products.view.configurable-options.before', ['product' => $product]); ?>


    <v-product-configurable-options :errors="errors"></v-product-configurable-options>

    <?php echo view_render_event('frooxi.shop.products.view.configurable-options.after', ['product' => $product]); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script type="module">
            ...
            app.component('v-product-configurable-options', {
                ...
                data() {
                    return {
                        config: <?php echo json_encode(app('Frooxi\Product\Helpers\ConfigurableOption')->getConfigurationConfig($product), 15, 512) ?>,
...
<?php endif; ?><?php /**PATH /Users/tasfirulhaque/Frooxi/Iqbal Hossen/bagisto_ecom/packages/Frooxi/Shop/src/resources/views/products/view/types/configurable.blade.php ENDPATH**/ ?>