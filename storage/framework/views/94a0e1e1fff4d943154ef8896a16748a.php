...
<?php if (! $__env->hasRenderedOnce('cfc2bc36-e150-41c9-b846-180f3ed4ce29')): $__env->markAsRenderedOnce('cfc2bc36-e150-41c9-b846-180f3ed4ce29');
                ...
                >
                    ...
                    <template v-if="media.type === 'video'">
                        ...
                        <button
                            ...
                            :aria-label="isMuted ? '<?php echo app('translator')->get('shop::components.carousel.unmute'); ?>' : '<?php echo app('translator')->get('shop::components.carousel.mute'); ?>'"
                        >
                            <!-- Muted Icon -->
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.media.images.lazy','data' => ['class' => 'h-full w-full select-none object-cover',':lazy' => 'index === 0 ? false : true',':src' => 'media.media_url',':srcset' => 'media.media_url',':sizes' => '
                                \'(max-width: 525px) 525px, \' +
                                \'(max-width: 1024px) 1024px, \' +
                                \'(max-width: 1600px) 1280px, \' +
                                \'1920px\'
                            ',':alt' => 'media?.title || \'Carousel Image \' + (index + 1)','tabindex' => '0',':fetchpriority' => 'index === 0 ? \'high\' : \'low\'',':decoding' => 'index === 0 ? \'sync\' : \'async\'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-full w-full select-none object-cover',':lazy' => 'index === 0 ? false : true',':src' => 'media.media_url',':srcset' => 'media.media_url',':sizes' => '
                                \'(max-width: 525px) 525px, \' +
                                \'(max-width: 1024px) 1024px, \' +
                                \'(max-width: 1600px) 1280px, \' +
                                \'1920px\'
                            ',':alt' => 'media?.title || \'Carousel Image \' + (index + 1)','tabindex' => '0',':fetchpriority' => 'index === 0 ? \'high\' : \'low\'',':decoding' => 'index === 0 ? \'sync\' : \'async\'']); ?>
...
<?php /**PATH /Users/tasfirulhaque/Frooxi/Iqbal Hossen/bagisto_ecom/packages/Frooxi/Shop/src/resources/views/components/carousel/index.blade.php ENDPATH**/ ?>