...
<?php $component->withAttributes([]); ?>
    <!-- Page title -->
     <?php $__env->slot('title', null, []); ?> 
        <?php echo app('translator')->get('admin::app.components.layouts.sidebar.settings'); ?>
     <?php $__env->endSlot(); ?>
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            <?php echo app('translator')->get('admin::app.configuration.index.info'); ?>
        </p>
    </div>
    ...
    <form
        action="<?php echo e(route('admin.settings.page.store')); ?>"
        method="POST"
            ...
            <div class="rounded-xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        ><?php echo e(old('store_address', $settings['store_address'])); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        >
                            <?php $__currentLoopData = [12, 24, 36, 48]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perPage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option
                                    value="<?php echo e($perPage); ?>"
                                    <?php echo e((string) old('products_per_page', $settings['products_per_page']) == (string) $perPage ? 'selected' : ''); ?>
                        ...
                        >
                            <?php $__currentLoopData = [
                                ...
                                <option
                                    ...
                                    <?php echo e(old('default_sort', $settings['default_sort']) === $value ? 'selected' : ''); ?>
                        ...
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <label class="relative inline-flex cursor-pointer items-center">
                                ...
                                <input
                                    ...
                                    value="1"
                                    class="peer sr-only"
                                    <?php echo e(old('show_out_of_stock', $settings['show_out_of_stock']) ? 'checked' : ''); ?>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            name="order_prefix"
                            value="<?php echo e(old('order_prefix', $settings['order_prefix'])); ?>"
                            class="form-input block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 transition-colors placeholder:text-gray-400 hover:border-gray-400 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                            placeholder="ORD-"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="<?php echo e(old('min_order_amount', $settings['min_order_amount'] ?? 0)); ?>"
                            min="0"
                            step="0.01"
                            class="form-input block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 transition-colors placeholder:text-gray-400 hover:border-gray-400 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                            placeholder="0"
...
<?php endif; ?>
<?php /**PATH /Users/tasfirulhaque/Frooxi/Iqbal Hossen/bagisto_ecom/packages/Frooxi/Admin/src/resources/views/settings/index.blade.php ENDPATH**/ ?>