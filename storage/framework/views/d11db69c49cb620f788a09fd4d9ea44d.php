<?php $reviewHelper = app('Frooxi\Product\Helpers\Review'); ?>
<?php $productViewHelper = app('Frooxi\Product\Helpers\View'); ?>
...
<?php $__env->startPush('meta'); ?>
    ...
    <?php if(core()->getConfigData('catalog.rich_snippets.products.enable')): ?>
        <script type="application/ld+json">
            <?php echo app('Frooxi\Product\Helpers\SEO')->getProductJsonLd($product); ?>
...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('808f741a-df34-4c4c-ac3c-4c0559594c3d')): $__env->markAsRenderedOnce('808f741a-df34-4c4c-ac3c-4c0559594c3d');
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <?php if ($__env->exists('shop::products.view.types.simple')) echo $__env->make('shop::products.view.types.simple', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                            <?php if ($__env->exists('shop::products.view.types.configurable')) echo $__env->make('shop::products.view.types.configurable', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                            <?php if ($__env->exists('shop::products.view.types.grouped')) echo $__env->make('shop::products.view.types.grouped', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                            <?php if ($__env->exists('shop::products.view.types.bundle')) echo $__env->make('shop::products.view.types.bundle', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                            <?php if ($__env->exists('shop::products.view.types.downloadable')) echo $__env->make('shop::products.view.types.downloadable', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                            <?php if ($__env->exists('shop::products.view.types.booking')) echo $__env->make('shop::products.view.types.booking', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/tasfirulhaque/Frooxi/Iqbal Hossen/bagisto_ecom/packages/Frooxi/Shop/src/resources/views/products/view.blade.php ENDPATH**/ ?>