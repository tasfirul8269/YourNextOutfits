...
<?php $component->withAttributes(['has-header' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'has-feature' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'has-footer' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
    ...
    <div id="auth-outer" style="display:flex;min-height:100vh;font-family:'Montserrat',sans-serif;">
        ...
        <div id="auth-right" style="flex:1;background:#fff;display:flex;flex-direction:column;justify-content:center;padding:64px 72px;overflow-y:auto;">
            ...
            <?php echo view_render_event('frooxi.shop.customers.forget_password.before'); ?>
...
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('shop.customers.forgot_password.store'))]); ?>
                <?php echo view_render_event('frooxi.shop.customers.forget_password_form_controls.before'); ?>
...
<?php endif; ?>
                ...
                <?php echo view_render_event('frooxi.shop.customers.forget_password_form_controls.email.after'); ?>
...
<?php endif; ?>
                ...
                <?php echo view_render_event('frooxi.shop.customers.forget_password_form_controls.after'); ?>
...
<?php endif; ?>
            ...
            <?php echo view_render_event('frooxi.shop.customers.forget_password.after'); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/YourNextOutfits/packages/Frooxi/Shop/src/Providers/../Resources/views/customers/forgot-password.blade.php ENDPATH**/ ?>