    ...
    <div style="border-bottom:1px solid #e5e7eb;background:#fff;">
        <div class="container px-[60px] max-lg:px-8 max-sm:px-4" style="display:flex;align-items:center;justify-content:space-between;padding-top:20px;padding-bottom:20px;">
            <a href="<?php echo e(route('shop.home.index')); ?>" style="display:flex;align-items:center;gap:12px;text-decoration:none;">
                <img src="<?php echo e(asset('themes/shop/logo_black.png')); ?>" alt="<?php echo e(config('app.name')); ?>" style="height:36px;width:auto;">
            </a>
...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('f05084a2-f7a9-4b05-95c4-af46bab3a0a2')): $__env->markAsRenderedOnce('f05084a2-f7a9-4b05-95c4-af46bab3a0a2');
...
<?php endif; ?>
<?php /**PATH /Users/tasfirulhaque/Frooxi/Iqbal Hossen/bagisto_ecom/packages/Frooxi/Shop/src/resources/views/checkout/onepage/index.blade.php ENDPATH**/ ?>