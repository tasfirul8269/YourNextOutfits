<?php echo view_render_event('frooxi.shop.layout.header.before'); ?>
...
<header 
    ...
    class="<?php echo e(request()->routeIs('shop.home.index') ? 'absolute top-0 left-0 right-0 is-homepage' : 'relative'); ?> z-[1000] w-full transition-all duration-300"
    style="<?php echo e(request()->routeIs('shop.home.index') ? 'background: linear-gradient(to bottom, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0) 100%) !important;' : 'background-color: #ffffff !important; box-shadow: 0 1px 0 rgba(0,0,0,0.08);'); ?>"
>
    <v-header-switcher>
...
<?php if (! $__env->hasRenderedOnce('21c89aec-7695-483c-bf9d-039c876255d8')): $__env->markAsRenderedOnce('21c89aec-7695-483c-bf9d-039c876255d8');
...
<?php /**PATH /Users/tasfirulhaque/Frooxi/Iqbal Hossen/bagisto_ecom/packages/Frooxi/Shop/src/resources/views/components/layouts/header/index.blade.php ENDPATH**/ ?>