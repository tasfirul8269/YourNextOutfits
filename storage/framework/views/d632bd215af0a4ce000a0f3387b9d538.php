...
<?php endif; ?>
    ...
    <div class="flex-auto mx-4 max-md:mx-6 max-sm:mx-4">
        <div class="flex items-center justify-between">
            ...
            <?php echo view_render_event('frooxi.shop.customers.account.profile.edit_button.before'); ?>
            ...
            <?php echo view_render_event('frooxi.shop.customers.account.profile.edit_button.after'); ?>

        </div>

        <!-- Profile Information -->
        <div class="grid grid-cols-1 mt-8 gap-y-6 max-md:mt-5 max-sm:gap-y-4">
            <?php echo view_render_event('frooxi.shop.customers.account.profile.first_name.before'); ?>
            ...
            <?php echo view_render_event('frooxi.shop.customers.account.profile.first_name.after'); ?>


            <?php echo view_render_event('frooxi.shop.customers.account.profile.last_name.before'); ?>
            ...
            <?php echo view_render_event('frooxi.shop.customers.account.profile.last_name.after'); ?>


            <?php echo view_render_event('frooxi.shop.customers.account.profile.gender.before'); ?>
            ...
            <?php echo view_render_event('frooxi.shop.customers.account.profile.gender.after'); ?>


            <?php echo view_render_event('frooxi.shop.customers.account.profile.date_of_birth.before'); ?>
            ...
            <?php echo view_render_event('frooxi.shop.customers.account.profile.date_of_birth.after'); ?>


            <?php echo view_render_event('frooxi.shop.customers.account.profile.email.before'); ?>
            ...
            <?php echo view_render_event('frooxi.shop.customers.account.profile.email.after'); ?>


            <?php echo view_render_event('frooxi.shop.customers.account.profile.delete.before'); ?>
...
<?php endif; ?>
            ...
            <?php echo view_render_event('frooxi.shop.customers.account.profile.delete.after'); ?>
...
<?php endif; ?>
<?php /**PATH /Users/tasfirulhaque/Frooxi/Iqbal Hossen/bagisto_ecom/packages/Frooxi/Shop/src/resources/views/customers/account/profile/index.blade.php ENDPATH**/ ?>