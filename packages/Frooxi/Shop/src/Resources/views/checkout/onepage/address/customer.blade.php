{!! view_render_event('frooxi.shop.checkout.onepage.address.customer.before') !!}
...
{!! view_render_event('frooxi.shop.checkout.onepage.address.customer.after') !!}
                        ...
                        <div class="mb-2 grid grid-cols-2 gap-5 max-1060:grid-cols-[1fr] max-lg:grid-cols-2 max-md:mt-2 max-md:grid-cols-1">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p class="text-base text-black">@lang('shop::app.checkout.onepage.address.add-new-address')</p>
                                </div>
                            </div>
                        </div>
