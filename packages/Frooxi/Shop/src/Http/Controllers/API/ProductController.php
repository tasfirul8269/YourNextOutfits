...
// use Frooxi\Marketing\Jobs\UpdateCreateSearchTerm as UpdateCreateSearchTermJob;
use Frooxi\Shop\Http\Resources\ProductResource;
...
class ProductController extends APIController
{
    ...
    public function index(): JsonResource
    {
        ...
        if (! empty($query)) {
             ...
             * REMOVED: Marketing package deleted - search term tracking disabled
             */
            // REMOVED: Marketing package deleted
            /*
