...
namespace Frooxi\Theme;

use Frooxi\Theme\Exceptions\ViterNotFound;
...
class Themes
{
    ...
    public function url(string $filename, ?string $namespace = null)
    {
         ...
         */
        $viters = config('yournext-vite.viters');
    ...
    /**
     * Set yournext vite in current theme.
     *
     * @param  mixed  $entryPoints
     * @return mixed
     */
    public function setYournextVite($entryPoints, ?string $namespace = null)
    {
        /**
         * If the namespace is null, it means the theming system is activated. We use the request URI to
         * detect the theme and provide Vite assets based on the current theme.
        ...
        if (empty($namespace)) {
            ...
            return $currentTheme->setYournextVite($entryPoints);
        }
