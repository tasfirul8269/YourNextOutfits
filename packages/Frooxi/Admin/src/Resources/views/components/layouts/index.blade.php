...
<head>
    {!! view_render_event('frooxi.admin.layout.head.before') !!}
    ...
    <link
        rel="preload"
        as="image"
        href="{{ asset('themes/shop/logo.png') }}"
    >
    ...
    {!! view_render_event('frooxi.admin.layout.head.after') !!}
</head>

<body class="h-full dark:bg-gray-950">
    {!! view_render_event('frooxi.admin.layout.body.before') !!}
    ...
    >
        ...
        {!! view_render_event('frooxi.admin.layout.content.before') !!}
        ...
        {!! view_render_event('frooxi.admin.layout.content.after') !!}
    </div>

    {!! view_render_event('frooxi.admin.layout.body.after') !!}

    @stack('scripts')

    {!! view_render_event('frooxi.admin.layout.vue-app-mount.before') !!}
    ...
    {!! view_render_event('frooxi.admin.layout.vue-app-mount.after') !!}
</body>
