...
// REMOVED: MagicAI package not installed
// use Frooxi\MagicAI\AiProvider;
...
return [
    ...
    /**
     * Magic AI - REMOVED (Package not installed)
     * Uncomment below if you reinstall the MagicAI package
     */
    // [
    //     'key' => 'magic_ai',
    //     ... (entire MagicAI section disabled)
    // ],
    ...
    [
        ...
        'name' => 'admin::app.configuration.index.sales.payment-methods.sslcommerz',
        'info' => 'admin::app.configuration.index.sales.payment-methods.sslcommerz-info',
        'sort' => 7,
        'fields' => [
            [
                'name' => 'active',
                ...
                'name' => 'sandbox',
                'title' => 'admin::app.configuration.index.sales.payment-methods.sslcommerz-sandbox',
                'type' => 'boolean',
                'info' => 'admin::app.configuration.index.sales.payment-methods.sslcommerz-sandbox-info',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
            ], [
                'name' => 'store_id',
                'title' => 'admin::app.configuration.index.sales.payment-methods.sslcommerz-store-id',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'store_password',
                'title' => 'admin::app.configuration.index.sales.payment-methods.sslcommerz-store-pass',
                'type' => 'password',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
        ...
        'name' => 'admin::app.configuration.index.sales.payment-methods.bkash',
        'info' => 'admin::app.configuration.index.sales.payment-methods.bkash-info',
        'sort' => 8,
        'fields' => [
            [
                'name' => 'active',
                ...
                'name' => 'sandbox',
                'title' => 'admin::app.configuration.index.sales.payment-methods.bkash-sandbox',
                'type' => 'boolean',
                'info' => 'admin::app.configuration.index.sales.payment-methods.bkash-sandbox-info',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
            ], [
                'name' => 'app_key',
                'title' => 'admin::app.configuration.index.sales.payment-methods.bkash-app-key',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'app_secret',
                'title' => 'admin::app.configuration.index.sales.payment-methods.bkash-app-secret',
                'type' => 'password',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'username',
                'title' => 'admin::app.configuration.index.sales.payment-methods.bkash-username',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'password',
                'title' => 'admin::app.configuration.index.sales.payment-methods.bkash-password',
                'type' => 'password',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
        ...
        'fields' => [
            [
                ...
                'type' => 'select',
                'default' => 0,
                'options' => 'Frooxi\Tax\Repositories\TaxCategoryRepository@getConfigOptions',
            ], [
                'name' => 'product',
