...
namespace Frooxi\Installer\Console\Commands;

use DateTimeZone;
use Frooxi\Installer\Events\ComposerEvents;
use Frooxi\Installer\Helpers\DatabaseManager;
use Frooxi\Installer\Helpers\EnvironmentManager;
...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'yournext:install
     ...
     * @var string
     */
    protected $description = 'Frooxi installer.';
    ...
    public function handle(): void
    {
        ...
        $this->warn('Step: Seeding basic data for Frooxi kickstart...');
    ...
    protected function askForApplicationDetails(): void
    {
        $this->updateTextTypeEnv(
            ...
            $this->getEnvVariable('APP_NAME', 'Frooxi')
        );
    ...
    protected function askForAdminDetails()
    {
        ...
        try {
            ...
            File::put($filePath, 'Frooxi is successfully installed.');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use Frooxi.');
    ...
    protected function askForGithubStar(): void
    {
        ...
        $repoUrl = 'https://github.com/yournext/yournext';
