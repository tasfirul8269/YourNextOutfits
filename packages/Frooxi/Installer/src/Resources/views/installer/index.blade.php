...
>
    <head>
        ...
        @frooxiVite(['src/Resources/assets/css/app.css', 'src/Resources/assets/js/app.js'], 'installer')
        ...
        @pushOnce('scripts')
            ...
            >
                    ...
                    <div class="m-auto grid h-[100vh] max-w-[362px] items-end">
                        <div class="grid gap-4">
                            <img
                                ...
                                alt="@lang('installer::app.installer.index.yournext-logo')"
                            >
                        ...
                        <p class="mb-6 w-full place-self-end text-left">
                            <a
                                ...
                                href="https://frooxi.com/en/"
                            >
                                @lang('installer::app.installer.index.yournext')
                            </a>

                            <span>@lang('installer::app.installer.index.yournext-info')</span>
                    ...
                    <div class="flex h-[484px] flex-col justify-center gap-4 overflow-y-auto px-7 py-4">
                        <div class="flex flex-col gap-4">
                            <p class="text-lg font-bold text-gray-800">
                                @lang('installer::app.installer.index.installation-processing.yournext')
                            </p>
                            ...
                            <div class="grid gap-2.5">
                                ...
                                <img
                                    ...
                                    src="{{ frooxi_asset('images/installer/spinner.svg', 'installer') }}"
                                    alt="Loading"
                                />

                                <p class="text-sm text-gray-600">
                                    @lang('installer::app.installer.index.installation-processing.yournext-info')
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex h-[484px] flex-col gap-3 overflow-y-auto border-b border-gray-300 px-7 py-4">
                                ...
                                <x-installer::form.control-group class="mb-2.5">
                                    ...
                                    <x-installer::form.control-group.control
                                        type="text"
                                        name="app_name"
                                        ::value="envData.app_name ?? 'Frooxi'"
                                        rules="required"
                                        :label="trans('installer::app.installer.index.environment-configuration.application-name')"
                                        :placeholder="trans('installer::app.installer.index.environment-configuration.yournext')"
                                    />
                            ...
                            <div class="flex h-[484px] flex-col gap-3 overflow-y-auto border-b border-gray-300 px-7 py-4">
                                ...
                                <x-installer::form.control-group class="mb-2.5">
                                    ...
                                    <x-installer::form.control-group.control
                                        ...
                                        :placeholder="trans('installer::app.installer.index.create-administrator.yournext')"
                                    />
                ...
                >
                    ...
                    <div class="flex items-center justify-between px-4 py-2.5">
                        <a
                            href="https://forums.frooxi.com"
                            class="cursor-pointer text-xs font-semibold text-blue-600"
                        >
                            @lang('installer::app.installer.index.installation-completed.yournext-forums')
                        </a>

                        <a
                            href="https://frooxi.com/en/extensions"
                            class="cursor-pointer rounded-md border border-blue-700 bg-white px-3 py-1.5 font-semibold text-blue-600 hover:opacity-90"
                        >
                            @lang('installer::app.installer.index.installation-completed.explore-yournext-extensions')
                        </a>
                    </div>
                </div>
            </script>
                            ...
                            const stepActions = {
                                envDatabase: (params, setErrors) => {
                                    if (params.db_connection === 'mysql') {
                                        ...
                                        setErrors({ 'db_connection': ["Frooxi currently supports MySQL only."] });
                                    }
                                },
