...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | All ACLs related to storefront will be placed here.
    |
    */
    [
        'key' => 'storefront',
        ...
        'key' => 'storefront.hero_carousel.create',
        'name' => 'admin::app.acl.create',
        'route' => 'admin.storefront.hero_carousel.store',
        'sort' => 1,
    ], [
        'key' => 'storefront.hero_carousel.edit',
        'name' => 'admin::app.acl.edit',
        'route' => 'admin.storefront.hero_carousel.update',
        'sort' => 2,
    ], [
        'key' => 'storefront.hero_carousel.delete',
        'name' => 'admin::app.acl.delete',
